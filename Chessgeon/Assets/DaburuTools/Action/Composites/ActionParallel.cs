...
namespace DaburuTools
{
	public class ActionParallel : Action
	{
		...
		public ActionParallel(params Action[] inActions)
		{
			_actionLinkedList = new LinkedList<Action>();
		...
		public override bool Add(Action inAction)
		{
			...
			_actionLinkedList.AddFirst(inAction);
			return true;
		}
		public bool Add(params Action[] inActions)
		{
			for (int i = 0; i < inActions.Length; i++)
			{
				...
				_actionLinkedList.AddFirst(inActions[i]);
			}
		...
		public override bool Remove(Action inAction)
		{
			...
			if (_isResettable)
			{
				_storageLinkedList.AddFirst(_actionLinkedList.Find(inAction).Value);
			}

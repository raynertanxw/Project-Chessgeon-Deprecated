...
{
	public class DaburuTools_ActionScriptTemplateWindow : EditorWindow
	{
		...
		public static void Init()
		{
			...
			DaburuTools_ActionScriptTemplateWindow window =
				(DaburuTools_ActionScriptTemplateWindow)EditorWindow.GetWindowWithRect(
					typeof(DaburuTools_ActionScriptTemplateWindow),

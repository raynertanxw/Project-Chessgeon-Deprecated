...
namespace DaburuTools
{
	public class LocalRotateByAction : Action
	{
		...
		public LocalRotateByAction(Transform inTransform, Graph inGraph, Vector3 _desiredDelta, float inActionDuration)
		{
		...
		public LocalRotateByAction(Transform inTransform, Vector3 _desiredDelta, float inActionDuration)
		{
			_transform = inTransform;

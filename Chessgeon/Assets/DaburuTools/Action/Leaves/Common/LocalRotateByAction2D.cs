...
namespace DaburuTools
{
	public class LocalRotateByAction2D : Action
	{
		...
		public LocalRotateByAction2D(Transform inTransform, Graph inGraph, float _desiredZEulerAngle, float inActionDuration)
		{
		...
		public LocalRotateByAction2D(Transform inTransform, float _desiredZEulerAngle, float inActionDuration)
		{
			_transform = inTransform;

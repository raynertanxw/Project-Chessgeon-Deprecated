...
namespace DaburuTools
{
	public class MoveByAction : Action
	{
		...
		public MoveByAction(Transform inTransform, Graph inGraph, Vector3 _desiredDelta, float inActionDuration)
		{
		...
		public MoveByAction(Transform inTransform, Vector3 _desiredDelta, float inActionDuration)
		{
			_transform = inTransform;

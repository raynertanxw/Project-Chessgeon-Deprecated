...
namespace DaburuTools
{
	public class RotateByAction : Action
	{
		...
		public RotateByAction(Transform inTransform, Graph inGraph, Vector3 _desiredDelta, float inActionDuration)
		{
		...
		public RotateByAction(Transform inTransform, Vector3 _desiredDelta, float inActionDuration)
		{
			_transform = inTransform;
